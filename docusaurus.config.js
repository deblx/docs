...
const config = {
  title: 'Deblx',
  tagline: 'Game Development & Technical Documentation',
  ...
  organizationName: 'Deblx', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/deblx/docs/tree/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/deblx/docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
